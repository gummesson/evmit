...
test('Evmit()', function(t) {
  t.test('.on(name, fn)', function(assert) {
  ...
  t.test('.emit(name)', function(assert) {
    var emitter = new Evmit()
    emitter.on('test', function() {
  ...
  t.test('.off(name[, fn])', function(assert) {
    var emitter = new Evmit()
    emitter.on('test', function() {
  ...
  t.test('.once(name, fn)', function(assert) {
    var emitter = new Evmit()
  ...
  t.test('.listeners([name])', function(assert) {
    var emitter = new Evmit()
